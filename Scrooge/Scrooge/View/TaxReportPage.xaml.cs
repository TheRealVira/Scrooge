...
namespace Scrooge
{
    ...
    public partial class TaxReportPage
    {
        ...
        private void ButtonBase_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            this.UstGrid.ItemsSource =
                new ObservableCollection<GroupedPurchaseAndSalesViewModel>(
                    this.ReportData.PurchasesAndSales.Where(x => x.Type == EntryType.Sale));
            this.VstGrid.ItemsSource =
                new ObservableCollection<GroupedPurchaseAndSalesViewModel>(
                    this.ReportData.PurchasesAndSales.Where(x => x.Type == EntryType.Purchase));
